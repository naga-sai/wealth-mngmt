    ...
    render() {
      ...
      const styles = {
        ...
        line: {
          ...
          stroke: '#7dc7f4',
          strokeWidth: '2px',
          WebkitFilter: 'drop-shadow( 0px 2px 2px rgba(0,0,0,.3) )',
      ...
      return  (
          <div style={styles.container}>
              <text style={styles.yAxis}>Rate of Return [in %]</text>           
        <text style={styles.xAxis}>Number of Years</text>
